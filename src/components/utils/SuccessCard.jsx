const SuccessCard = (props) => {
  return (
    <>
      <div
        className={`absolute w-[100vw] h-[102vh] justify-center align-center ${props.bgColor} opacity-[0.9]`}
        style={{ zIndex: 2 }}
      ></div>
      <div
        className="absolute justify-center items-center bg-gray-100 flex flex-col px-8 rounded-2xl max-md:px-5 max-w-[33rem] max-h-[26rem]"
        style={{ zIndex: 5 }}
      >
        ...
        <button
          ...
          className="text-gray-50 text-base font-semibold leading-4 whitespace-nowrap justify-center items-center bg-blue-500 self-stretch my-8 px-5 py-4 rounded-xl max-md:max-w-full"
        >
          {props.buttonName}
        </button>
      </div>
