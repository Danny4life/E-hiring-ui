...
const ProfilePopUp = ({ handleProfile, handleProfilePop }) => {
  ...
  return (
    <div className="items-stretch bg-white flex flex-col py-4 w-fit px-6 rounded-xl">
      ...
      <div
        ...
        className="cursor-pointer hover:bg-blue-300 ease-in-out duration-200 items-center bg-white flex w-full gap-2.5 pl-8 pr-16 p-2 max-md:px-5"
      >
        <img
          loading="lazy"
