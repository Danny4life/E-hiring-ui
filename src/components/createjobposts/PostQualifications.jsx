    ...
    <div className="w-fit mb-[4rem] mx-auto flex flex-col items-stretch">
      <div className="justify-between self-center max-w-full">
        <div className="mx-auto items-start flex flex-col max-w-[500px]">
          ...
          <button
            onClick={handleStep3}
            className="text-white text-base font-semibold leading-6 tracking-normal whitespace-nowrap justify-center items-stretch bg-blue-500 w-[104px] max-w-full mt-8 px-4 py-2 rounded-xl self-end"
          >
            Continue
          </button>
        </div>
...
export default PostQualifications;
