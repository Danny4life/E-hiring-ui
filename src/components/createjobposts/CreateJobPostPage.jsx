...
import CreateJobPostNav from "./CreateJobPostNav";
import JobInformation from "./JobInformation";
import PostQualifications from "./PostQualifications";
import PostNewJobRequirements from "./PostNewJobRequirements";


const CreateJobPostPage = ({ handleFindCandidatesPage }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios
        .post("http://localhost:8080/job-post/create-job-post", formData, {
          headers: {
  ...
  return (
    <>
      <CreateJobPostNav p1={handleStep1} p2={handleStep2} p3={handleStep3} />
