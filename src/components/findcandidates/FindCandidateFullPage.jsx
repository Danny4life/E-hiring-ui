...
import JobPostCard from "../findjobposts/JobPostCard";
import AppliedCandidateCard from "./AppliedCandidateCard";
import JobPostFullRequirements from "./JobPostFullRequirements";
import AppliedCandidateCredentials from "./AppliedCandidateCredentials";


const FindCandidateFullPage = () => {
  const activeStyle = {
  ...
  useEffect(() => {
    const fetchJobPosts = async () => {
      await axios
        .get("http://localhost:8080/employer/job-posts", {
          headers: {
        ...
        .then((response) => {
          ...
          setSelectedCandidate(
            response.data.data[0].applications.jobSeekerInfo
          );
...
export default FindCandidateFullPage;
