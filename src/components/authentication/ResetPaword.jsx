...
const ResetPaword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios
        .post("http://localhost:8080/auth/reset-forgot-password", formData)
        .then((result) => {
          ...
          SweetAlert(
            ...
            "You have successfully reset your password, you can proceed to login",
            3000
          );
