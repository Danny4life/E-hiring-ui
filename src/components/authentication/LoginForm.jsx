...
const LoginForm = ({ onAuth, handleSignUp }) => {
  ...
  return (
    <div>
      ...
      {/* <Link
        to="/employer-signup"
        className="fixed bg-black top-[7rem] right-[1rem] cursor-pointer hover:bg-blue-500 justify-between items-stretch border-[color:var(--blue-600,#2563EB)] self-stretch flex gap-4 pl-7 pr-3 py-3 rounded-lg border-2 border-solid max-md:pl-5 my-auto max-h-[3rem]"
      >
        <div className="text-white text-base font-medium leading-6 tracking-wide">
      ...
      {/* <Link
        to="/jobseeker-signup"
        className="fixed bg-black top-[11rem] right-[1rem] cursor-pointer hover:bg-blue-500 justify-between items-stretch border-[color:var(--blue-600,#2563EB)] self-stretch flex gap-4 pl-7 pr-3 py-3 rounded-lg border-2 border-solid max-md:pl-5 my-auto max-h-[3rem]"
      >
        <div className="text-white text-base font-medium leading-6 tracking-wide">
      ...
      <div className={`register-cont ${blur}`}>
        <form
          ...
          className="register-form w-[40vw] py-3 px-8"
        >
          <div>
            <div className="top">
              <div className="logo">
          ...
          <div className="col-span-full mt-2" style={{ color: "#98A2B3" }}>
            <h3>
              <Link to="/forgot-password" style={{ color: "#2F80ED" }}>
                {" "}
                Forgot password?{" "}
              </Link>
            </h3>
          ...
          >
            <h3>
              ...
              <span onClick={handleSignUp} className="">
                <span
                  style={{ color: "#2F80ED" }}
                  className="text-white text-base font-medium leading-6 tracking-wide cursor-pointer"
                >
                  Sign up here
                </span>
              </span>
