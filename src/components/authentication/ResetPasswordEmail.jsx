...
const ResetPasswordEmail = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post("http://localhost:8080/auth/forgot-password", formData).then((result) => {
        setClip(false);

        SweetAlert(
          "success",
          "Email Sent",
          "An Email has been sent to your Email, Proceed to your Email for further Instructions",
          4000
        );
