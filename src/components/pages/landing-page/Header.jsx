    ...
    <div className="sticky top-[0] w-full bg-white z-20">
      <div className="max-w-[1280px] items-center mx-auto justify-between items-stretch self-stretch border-b-[color:var(--blue-gray-200,#E2E8F0)] flex gap-5 pl-20 pr-6 pb-2 border-b border-solid max-md:flex-wrap max-md:px-5">
        ...
        <div className="items-center flex justify-between gap-5">
          <Link
            to="/login"
            className="flex items-center text-blue-600 text-base font-medium leading-6 tracking-wide my-auto"
          >
            Log In
          </Link>
          <div
            onClick={handleSignUp}
            className="cursor-pointer hover:bg-blue-500 justify-between items-stretch border-[color:var(--blue-600,#2563EB)] bg-blue-600 self-stretch flex gap-4 pl-7 pr-3 py-3 rounded-lg border-2 border-solid max-md:pl-5 my-auto max-h-[3rem]"
          >
