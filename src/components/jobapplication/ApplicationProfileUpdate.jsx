const ApplicationProfileUpdate = ({ handleShowInfo, userData }) => {
  return (
    <form className="items-end flex flex-col max-w-[500px]">
      ...
      <div
        ...
        className="text-white text-base font-semibold leading-6 tracking-normal whitespace-nowrap justify-center items-stretch bg-blue-500 w-[145px] max-w-full mt-6 px-4 py-2 rounded-xl self-end cursor-pointer"
      >
        Save Changes
      </div>
    </form>
...
export default ApplicationProfileUpdate;
