...
const JobSeekerTopHeader = ({
  ...
  return (
    <div
      className="sticky top-[0] shadow-lg justify-between items-stretch bg-white flex w-full gap-5 px-12 pt-2 max-md:max-w-full max-md:flex-wrap max-md:px-5"
      style={{ zIndex: 4 }}
    >
      ...
      <div className="self-center flex gap-6 my-auto">
        <div
          onClick={handleFindJobPage}
          className="group relative cursor-pointer"
        >
          <div
            onClick={activePageToFindJobs}
            className={`${
              active === "findJobs" ? "active-nav" : ""
      ...
      <div className="items-stretch flex justify-between gap-5 max-md:justify-center">
        ...
        >
          <div
            onClick={activePageToChat}
            className={`${
              active === "chat" ? "active-nav" : ""
            } text-black-200 text-base font-bold leading-6 tracking-normal transition-colors duration-300 group-hover:text-blue-500 whitespace-nowrap`}
          >
            <img
              loading="lazy"
...
export default JobSeekerTopHeader;
