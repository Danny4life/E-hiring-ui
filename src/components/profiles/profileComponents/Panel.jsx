const Panel = ({ btnName, imgDis, fontColor, handleClick }) => {
  return (
    <div
      onClick={handleClick}
      className="justify-between items-stretch flex w-full gap-5 max-w-[322px] px-[8px] py-[4px] cursor-pointer"
    >
      <div className="items-stretch flex justify-between gap-4">
        ...
        />
        <div
          className={`${fontColor} text-base font-medium leading-6 tracking-normal self-center grow whitespace-nowrap my-auto`}
        >
          {btnName}
        </div>
      </div>
