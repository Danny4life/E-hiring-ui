...
const ProfilePictureUpload = ({ handleChangeAvatar }) => {
  ...
  function uploadSingleFile(profilePic) {
    ...
    axios
      .put("http://localhost:8080/users/profile-picture", formData, {
        headers: {
  ...
  return (
    <form
      ...
      className={`${blur} flex flex-col bg-black items-stretch absolute h-[100vh] w-[100vw] p-[10rem] max-md:w-full max-md:ml-0 opacity-[0.9]`}
      style={{ zIndex: 2 }}
    >
      <div className="items-start mx-auto grid justify-center grow max-md:max-w-full max-md:mt-10">
        ...
        <div
          {...getRootProps()}
          className="w-[30vw] max-h-100 border-2 border-dashed border-gray-300 rounded-lg p-4 mb-4 text-white text-center"
        >
          <input {...getInputProps()} />
        ...
        <div className="flex justify-center">
          <div
            ...
            className="text-white text-base font-semibold leading-6 tracking-normal whitespace-nowrap mx-auto justify-center items-stretch bg-blue-500 w-fit max-w-full px-8 py-2 rounded-xl self-end cursor-pointer"
          >
            Cancel
          </div>
